...
class BlogPost(models.Model):
	...
	labels = models.ManyToManyField(YmeLabel, null=True, blank=True, related_name="blog_posts", verbose_name=_("YmeLabel"))
	...
	def share_url(self):
		if not self.is_published:
			if self.secret_key:
				return reverse("yme_blog:blog_post_secret", kwargs={"post_secret_key": self.secret_key})
			else:
				return u"保存文档自动生成链接"
		else:
